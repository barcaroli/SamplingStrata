...
#> 1    1*7 1   7.00  360.0 0.000000   0.00000    1    0    1  1  7
#> 2    1*5 5  10.00  467.6 4.195235  79.79624    1    0    1  1  5
#> 3   1*13 5  12.20 1085.4 3.187475 537.57924    1    0    1  1 13
#> 4    1*8 4  16.25  734.5 3.418699 153.20003    1    0    1  1  8
#> 5    1*9 2  15.50  530.0 1.500000  70.00000    1    0    1  1  9
#> 6  10*15 1 258.00 3541.0 0.000000   0.00000    1    0    1 10 15
```
...
![plot of chunk optim1](figure/optim1-1.png)![plot of chunk optim1](figure/optim1-2.png)![plot of chunk optim1](figure/optim1-3.png)
...
#>         cv(Y1)    cv(Y2)
#> DOM1 0.0999223 0.0998300
#> DOM2 0.0973083 0.0999961
#> DOM3 0.0984079 0.0997399
```
...
![plot of chunk initsol](figure/initsol-1.png)![plot of chunk initsol](figure/initsol-2.png)![plot of chunk initsol](figure/initsol-3.png)
...
![plot of chunk optim2](figure/optim2-1.png)![plot of chunk optim2](figure/optim2-2.png)![plot of chunk optim2](figure/optim2-3.png)
...
#>         cv(Y1)    cv(Y2)
#> DOM1 0.0995715 0.0960840
#> DOM2 0.0995359 0.0236793
#> DOM3 0.0992537 0.0251076
```
...
![plot of chunk init_sol3](figure/init_sol3-1.png)![plot of chunk init_sol3](figure/init_sol3-2.png)![plot of chunk init_sol3](figure/init_sol3-3.png)
...
Note that this time we call a different function (*KmeansSolution2*) that requires, instead of the *strata* dataframe, directly the *frame* dataframe. 
...
![plot of chunk optim3](figure/optim3-1.png)![plot of chunk optim3](figure/optim3-2.png)![plot of chunk optim3](figure/optim3-3.png)
...
#> 1      1       1        354         15     0.042424       27     2914       32      847
#> 2      1       2         98          8     0.079911       65     4281      185     1929
#> 3      1       3         66          8     0.128525      130     4371     1568     6410
#> 4      1       4         47          8     0.175200      155    29559      129     6723
#> 5      1       5          6          2     0.333333       78     6261     7093     8925
#> 6      1       6          7          3     0.372469      212     7515     9009    10117
```
...
<table class="table table-condensed">
 <thead>
  <tr>
   ...
   <th style="text-align:right;"> Bounds Total Population </th>
   <th style="text-align:right;"> Bounds Total Area </th>
  </tr>
 </thead>
<tbody>
  <tr>
   ...
   <td style="text-align:right;"> 0.02384623 </td>
   <td style="text-align:right;"> 109-2096 </td>
  ...
  <tr>
   ...
   <td style="text-align:right;"> 0.04171346 </td>
   <td style="text-align:right;"> 222-3271 </td>
   <td style="text-align:right;"> 155-943 </td>
  </tr>
  <tr>
   <td style="text-align:right;"> 3 </td>
   <td style="text-align:right;"> 58 </td>
   <td style="text-align:right;"> 8 </td>
   <td style="text-align:right;"> 0.13217846 </td>
   <td style="text-align:right;"> 744-18323 </td>
   <td style="text-align:right;"> 252-999 </td>
  </tr>
  <tr>
   ...
   <td style="text-align:right;"> 1608-5079 </td>
   <td style="text-align:right;"> 1007-1023 </td>
  </tr>
  <tr>
   <td style="text-align:right;"> 5 </td>
   <td style="text-align:right;"> 9 </td>
   <td style="text-align:right;"> 2 </td>
   <td style="text-align:right;"> 0.24469906 </td>
   <td style="text-align:right;"> 692-20370 </td>
   <td style="text-align:right;"> 1058-1106 </td>
  </tr>
  <tr>
   <td style="text-align:right;"> 6 </td>
   <td style="text-align:right;"> 6 </td>
   <td style="text-align:right;"> 2 </td>
   <td style="text-align:right;"> 0.33333333 </td>
   <td style="text-align:right;"> 566-7568 </td>
   <td style="text-align:right;"> 1119-1137 </td>
  </tr>
  <tr>
   <td style="text-align:right;"> 7 </td>
   <td style="text-align:right;"> 22 </td>
   <td style="text-align:right;"> 4 </td>
   <td style="text-align:right;"> 0.18175363 </td>
   <td style="text-align:right;"> 721-16654 </td>
   <td style="text-align:right;"> 1177-2029 </td>
  </tr>
  <tr>
   <td style="text-align:right;"> 8 </td>
   <td style="text-align:right;"> 1 </td>
   ...
   <td style="text-align:right;"> 166558-166558 </td>
   <td style="text-align:right;"> 2391-2391 </td>
  </tr>
</tbody>
</table>
...
eval3$coeff_var
#>      CV1    CV2  dom
#> 1 0.1012 0.0971 DOM1
#> 2 0.1093 0.0983 DOM2
#> 3 0.0967 0.1014 DOM3
eval3$rel_bias
#>        y1      y2  dom
#> 1 -0.0062 -0.0006 DOM1
#> 2 -0.0017 -0.0028 DOM2
#> 3 -0.0116 -0.0040 DOM3
```
...
![plot of chunk distrib](figure/distrib-1.png)
...
#>  114  units have been selected from  25  strata
#> 
...
![plot of chunk optim4](figure/optim4-1.png)![plot of chunk optim4](figure/optim4-2.png)![plot of chunk optim4](figure/optim4-3.png)
...
#>         cv(Y1)    cv(Y2)
#> DOM1 0.0995681 0.0990472
#> DOM2 0.0941192 0.0972517
#> DOM3 0.0903580 0.0899776
```
...
#> 
#> *** Sample has been drawn successfully ***
#>  139  units have been selected from  30  strata
#> 
#> ==> There have been  4  take-all strata 
#> from which have been selected  64 units
```
