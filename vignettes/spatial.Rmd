...
We can now proceed with the selection of the sample, using the function 'selectSampleSpatial' (which is a wrapping of function 'lpm2_kdtree' in package 'SamplingBigData', see @lisic2018b), in order to ensure a spatially balanced sample:
