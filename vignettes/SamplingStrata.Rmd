...
framenew$Y2 <- swissmunicipalities$Airind
framenew$Y3 <- swissmunicipalities$Airbat
results <- evalSolution(framenew, solution$aggr_strata, 200, progress = FALSE)
results$coeff_var
```

The first CV is the one related to *total population*, the other two regard respectively *industrial area* and *building area*: these latter two are more than compliant with the precision constraints.
