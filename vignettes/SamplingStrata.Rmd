...
We analyse the territorial distribution of the lead concentration, and model its relations with distance from the river and with the soil type, by using the subset of 155 points on which these values have been jointly observed: 
