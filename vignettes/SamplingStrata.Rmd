...
In order to speed processing we have selected only the first 3 regions and only the variables of interest for our example. 
...
strataStructure <- summaryStrata(framenew3,
                                 outstrata3,
                                 progress=FALSE)
